...
import com.nju.server.constant.Constants;
import com.nju.server.domain.Singer;
import com.nju.server.service.impl.SingerServiceImpl;
...
public class SingerController {
    ...
    public Object allSinger(){
        ...
        for(int i=0;i<list.size();i++){
            System.out.println(list.get(i).getBirth());
        }
